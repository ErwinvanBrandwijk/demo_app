...
describe "wishlistlines/new" do
  before(:each) do
    assign(:wishlistline, stub_model(Wishlistline,
      :name => "MyString",
      :quantity => 1,
      :price => "",
      :bought => 1,
  ...
  it "renders new wishlistline form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => wishlistlines_path, :method => "post" do
